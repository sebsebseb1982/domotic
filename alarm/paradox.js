...
module.exports = {
	getCredentials: (userCode, modulePassword, ses) => {
		let s_low = keeplowbyte(modulePassword);
		let temp = hex_md5(s_low);
		let spass = temp + ses;
		let p = hex_md5(spass);
		let u = rc4(spass, userCode);
